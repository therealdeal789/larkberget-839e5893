...
const ContactInfoSection = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
      <Card className="p-8 bg-white border border-larkberget-200">
        <CardHeader className="pb-4">
          <CardTitle className="flex items-center space-x-3 text-larkberget-900">
      ...
      <Card className="p-8 bg-white border border-larkberget-200">
        ...
        <CardContent>
          ...
          <div className="mt-4 pt-4 border-t border-larkberget-200">
